...
/* harmony default export */ __webpack_exports__["default"] = (async function ({
  ...
  while (true) {
    ...
    let menu = await addon.tab.waitForElement('[class*="sprite-selector_sprite-selector_"] [class*="action-menu_more-buttons_"], #react-tabs-3 [class*="action-menu_more-buttons_"]', {
      markAsSeen: true
    });
